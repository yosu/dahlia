defmodule DahliaWeb.UserAuthTest do
  use DahliaWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Dahlia.Account
  alias DahliaWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, DahliaWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      DahliaWeb.Endpoint.subscribe(live_socket_id)
