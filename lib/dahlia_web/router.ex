defmodule DahliaWeb.Router do
  use DahliaWeb, :router

  import DahliaWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {DahliaWeb.Layouts, :root}
  ...
  # scope "/api", DahliaWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:dahlia, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: DahliaWeb.Telemetry
